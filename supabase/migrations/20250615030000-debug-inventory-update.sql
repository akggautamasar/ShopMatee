...
-- Update the create_full_invoice function with better debugging and ensure inventory updates work
...
BEGIN
    ...
    LOOP
        ...
        IF v_item.product_id IS NOT NULL THEN
            ...
            IF FOUND THEN
                ...
                RAISE NOTICE 'Updating inventory for product %, current stock: %, reducing by: %', 
                ...
                RAISE NOTICE 'Inventory updated. New stock: %', v_current_stock;
            ELSE
                RAISE NOTICE 'No inventory record found for product %', v_item.product_id;
            END IF;
        END IF;
    END LOOP;
    ...
    -- Log final status
    RAISE NOTICE 'Invoice created: %, Inventory updated: %', v_invoice_id, v_inventory_updated;
