...
-- Function to create an invoice and its items atomically with auto-generated invoice number
...
BEGIN
    ...
    INSERT INTO public.ig_invoices (
        ...
        p_notes, p_terms, v_subtotal, v_total_tax, v_grand_total, 'Draft'
    ) RETURNING id INTO v_invoice_id;

    -- 3. Insert into ig_invoice_items table
    FOREACH v_item IN ARRAY p_items
    LOOP
